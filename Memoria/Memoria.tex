...
\item \textbf{Selección de modelo:} Usamos un modelo XGBoost. Para seleccionar los hiperparámetros, realizamos una validación cruzada de 5 bloques. Los parámetros explorados son... \todo{Añadir datos concretos}. El mejor resultado --- con hiperparámetros nrounds = 10, max_depth = 6, eta = 0.01, gamma = 1, colsample_bytree =
...
\item \textbf{Selección de modelo:} En este caso, utilizamos un Random Forest. Para la selección de hiperparámetros, se utiliza igualmente una validación cruzada de 5 bloques. Los parámetros...\todo{Añadir más datos}. El mejor resultado --- con hiperparámetros ntree = 300 y mtry = 18 --- obtuvo un accuracy de 0.8308112 en la validación cruzada.
\item \textbf{Resultado en Kaggle público:}
